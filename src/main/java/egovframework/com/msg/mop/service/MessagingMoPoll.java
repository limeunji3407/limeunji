...
public class MessagingMoPoll implements Serializable{
	...
	public String getTotal_send_cnt() {
		return total_send_cnt;
	}

	public void setTotal_send_cnt(String total_send_cnt) {
		this.total_send_cnt = total_send_cnt;
	}

	public String getRequest_cnt() {
		return request_cnt;
	}

	public void setRequest_cnt(String request_cnt) {
