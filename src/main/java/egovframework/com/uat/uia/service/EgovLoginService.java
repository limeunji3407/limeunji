...
public interface EgovLoginService {
    ...
    LoginVO getLockDt(LoginVO vo) throws Exception;
    LoginVO getPasswordDt(LoginVO vo) throws Exception;
    EgovMsgLinePriceVO getMsgPrice() throws Exception;
    ...
    String passwordFailReset(LoginVO vo) throws Exception;
    
    String passwordFail(LoginVO vo) throws Exception;
    String lockChange(LoginVO vo) throws Exception;
    
    String pwFailSerch(LoginVO vo) throws Exception;
    
    Integer mngCheck(LoginVO vo) throws Exception;
