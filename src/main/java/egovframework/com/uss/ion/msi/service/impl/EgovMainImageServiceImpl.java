...
public class EgovMainImageServiceImpl extends EgovAbstractServiceImpl implements EgovMainImageService {
	...
	public void insertMainImage2(MainImage mainImage) throws Exception {
		mainImageDAO.insertMainImage(mainImage);
	}
	...
	public void deleteMainImage2(int mainImage) throws Exception {
		mainImageDAO.deleteMainImage2(mainImage);
	}
	public void updateLogo(MainImage mainImage) throws Exception {
		mainImageDAO.updateLogo(mainImage);
	}
	public void updateLogoLocation(MainImage mainImage) throws Exception {
		mainImageDAO.updateLogoLocation(mainImage);
	}
	public void updateLogoImg(MainImage mainImage) throws Exception {
		mainImageDAO.updateLogoImg(mainImage);
	}
	/**
