...
public class EgovCtsnnManageController {
    ...
    @RequestMapping("/mng/personalevent.do")
	public String selectCtsnnManageList(@ModelAttribute("ctsnnManageVO") CtsnnManageVO ctsnnManageVO,
		...
		//return "egovframework/com/uss/ion/ctn/EgovCtsnnManageList";
		return "egovframework/com/mng/sts/EgovPersonalEventList";
	}

    @RequestMapping("/getHoliday.do")
	public String selectCtsnnManageListAjax(@ModelAttribute("ctsnnManageVO") CtsnnManageVO ctsnnManageVO,
			                                 ModelMap model) throws Exception {
    	
    	ctsnnManageVO.setRecordCountPerPage(999999);
		/** paging */
		PaginationInfo paginationInfo = new PaginationInfo();
		paginationInfo.setCurrentPageNo(ctsnnManageVO.getPageIndex());
		paginationInfo.setRecordCountPerPage(ctsnnManageVO.getPageUnit());
		...
		model.addAttribute("paginationInfo" ,   paginationInfo );
		model.addAttribute("data",   ctsnnManageVO.getCtsnnManageList());
        model.addAttribute("ctsnnCodeList"  ,   ctsnnCdCodeList);
 		model.addAttribute("message", egovMessageSource.getMessage("success.common.select"));
    ...
    @RequestMapping(value="/mng/insertCtsnnManage.do")
    public ModelAndView insertCtsnn(CtsnnManage ctsnnManage) throws Exception{
    	
    	ModelAndView mav = new ModelAndView("jsonView");
    	
    	ctsnnManage.setUsid("TEST1");
    	ctsnnManage.setStatus("Y");
    	
		System.out.println("-------insertNumber : " + ctsnnManage.getCtsnnNm() );
		DefaultTransactionDefinition def = new DefaultTransactionDefinition(); 
  		def.setPropagationBehavior(TransactionDefinition.PROPAGATION_REQUIRED); 
  		TransactionStatus txStatus = txManager.getTransaction(def); 
  		try{ 	
  			egovCtsnnManageService.insertCtsnn(ctsnnManage);
    ...
    @RequestMapping(value="/mng/deleteCtsnnManage.do")
    public ModelAndView deleteCtsnn(CtsnnManage ctsnnManage) throws Exception{
    	
    	ModelAndView mav = new ModelAndView("jsonView");
    	ctsnnManage.setStatus("N");
		System.out.println("-------insertNumber : " + ctsnnManage.getCtsnnNm() );
		DefaultTransactionDefinition def = new DefaultTransactionDefinition(); 
  		def.setPropagationBehavior(TransactionDefinition.PROPAGATION_REQUIRED); 
  		TransactionStatus txStatus = txManager.getTransaction(def); 
	 ...
	 */
	 ...
	 @RequestMapping(value="/updtCtsnnManage.do")
	 public ModelAndView updtCtsnnManage(     @ModelAttribute("ctsnnManage") CtsnnManage ctsnnManage,
			 @ModelAttribute("ctsnnManageVO") CtsnnManageVO ctsnnManageVO
			 ) throws Exception {
			 ModelAndView mav = new ModelAndView("jsonView");
