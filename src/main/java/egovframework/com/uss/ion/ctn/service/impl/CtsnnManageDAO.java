...
public class CtsnnManageDAO extends EgovComAbstractDAO {
	...
	public String insertCtsnn(CtsnnManage ctsnnManage) throws Exception{
    	
    	return String.valueOf((int)insert("ctsnnManageDAO.insertCtsnn", ctsnnManage));
    }
	...
	public void deleteCtsnnManage(CtsnnManage ctsnnManage) throws Exception {
        update("ctsnnManageDAO.deleteCtsnnManage",ctsnnManage);
	}
