...
public class EgovBannerServiceImpl extends EgovAbstractServiceImpl implements EgovBannerService {
	...
	public void insertBanner2(Banner banner) throws Exception{
        bannerDAO.insertBanner(banner);
	}
	...
	public void updateBanners(Banner banner) throws Exception{
		bannerDAO.updateBanners(banner);
	}
	...
	public void deleteBanner2(int banner) throws Exception {
        bannerDAO.deleteBanner2(banner);
	}
	/**
	...
	public void deleteBannerFile(Banner banner) throws Exception{
		...
		System.out.println("-------filevo-------" + fileVO.getFileStreCours()+fileVO.getStreFileNm());
