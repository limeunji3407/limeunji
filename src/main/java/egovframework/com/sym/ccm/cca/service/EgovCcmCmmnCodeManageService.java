...
public interface EgovCcmCmmnCodeManageService {
	...
	List<?> selectCmmCodeDetails(String codeId) throws Exception;
	 ...
	 * @throws Exception
	 */
	void updateCmmnCodeDetail(CmmnCodeDetail cmmnCodeVO) throws Exception;
	 ...
	 * @throws Exception
	 */
	void deleteCmmnCodeDetail(CmmnCodeDetail cmmnCodeVO) throws Exception;
	 ...
	 * @throws Exception
	 */
	void insertCmmnCodeDetail(CmmnCodeDetail cmmnCode) throws Exception;
