...
public class EgovCcmCmmnClCodeManageController {
	...
	public String selectCmmnClCodeListajax(@ModelAttribute("searchVO") CmmnClCodeVO searchVO, ModelMap model) throws Exception {
	 

		List<?> CmmnCodeList = cmmnClCodeManageService.selectCmmnClCodeList(searchVO);
		model.addAttribute("data", CmmnCodeList);
		System.out.println("--------getCommonCode------commoncode-------" + CmmnCodeList);  
