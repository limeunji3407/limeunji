...
<style>
div.checkbox-small>input[type="radio"] {
	display: none;
}

div.checkbox-small>input[type="radio"]+label {
...
div.checkbox-small>input[type="radio"]:checked+label {
	border: 1px solid #8bc5ff;
	background-color: #8bc5ff;
	background-image:
		url('../../../../../../images/egovframework/com/usr/checkbox_active.png');
...
<body>
<input type="radio" name="standard_tabmenu" id="tabmenu-3">
<label for="tabmenu-3">수신거부관리</label>
<div class="tabCon">
	<ul class="width-100 margin-bottom-100">
		<li class="width-100 padding-top-60">
			<div class="width-100 height-540px">
				<!--검색하기-->
				<div class="width-100 min-width-1110px margin-auto margin-bottom-100 ">
					<!-- 검색설정 -->
					<div
